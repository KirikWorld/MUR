...
export const TextRevealCard = ({
  ...
  return (
    <div
      ...
      ref={cardRef}
      className={cn(
        "bg-background border border-white/[0.08] w-full rounded-lg p-8 relative overflow-hidden",
        className
      )}
    >
      {children}
      ...
      <div className="h-40 relative flex items-center overflow-hidden">
        ...
        >
          <div
            ...
            className="py-10 text-white bg-clip-text text-transparent bg-gradient-to-b from-white to-neutral-300 text-center"
          >
            <GlitchText font={font} text={revealText} style={{ fontSize: "clamp(1rem, 4vw, 4rem)" }} />
            {/* {revealText} */}
          </div>
        </motion.div>
        <motion.div
        ...
        <div className="overflow-hidden [mask-image:linear-gradient(to_bottom,transparent,white,transparent)] w-full">
          ...
          {/* <GlitchText font={font} size={8} text={text} /> */}
          <MemoizedStars />
        </div>
      </div>
    </div>
